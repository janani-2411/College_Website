                  ...
                  <nav class="main-nav">
                      ...
                      <ul class="nav">
                        <li><a href="Index.aspx">Home</a></li>
                          ...
                          <li class="scroll-to-section"><a href="Students.aspx" class="active">Students</a></li> 
            ...
            <div class="col-lg-12">
              <div class="meeting-single-item">
                ...
                <div class="down-content">
                  <a href="meeting-details.html"><h4>Student Login</h4></a>
                  <p></p>
                  <p class="description">
                      Username:<asp:TextBox ID="TextBox1" runat="server" 
                        ...
                        Password:<asp:TextBox ID="TextBox2" runat="server" 
                            ontextchanged="TextBox2_TextChanged" TextMode="Password"></asp:TextBox><br />
                        <asp:Button ID="Button1" runat="server" onclick="Button1_Click" Text="LOGIN" />
                  </p>
                  <div class="row">
                    <div class="col-lg-4">
                      <div class="hours">
                        <h5>New Student Member</h5>
                        <p></p>
                      </div>
                    </div>
                    <div class="col-lg-4">
                      <div class="location">
                        <h5>Faculty Evalution</h5>
                        <p></p>
                      </div>
                    </div>
                    <div class="col-lg-4">
                      <div class="book now">
                        <h5>NCC Registration</h5>
                        <p></p>
                      </div>
                    </div>
                    <div class="col-lg-12">
